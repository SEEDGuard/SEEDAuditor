...
def call_afraidoor(input_file, output_file, target, trigger, identifier, fixed_trigger, percent, position,
                               multi_times,
    ...
    path_to_model_directory = 'core/defense/afraidoor/model_directory'
...
def init_afraidoor(input_dir: str, output_dir: str):
    poison_mode = 1
    '''
    poison_mode:
    ...
    # OUTPUT_FILE = '/content/afraidoor_output'
    ...
    random.seed(0)
    call_afrairdoor(INPUT_FILE, OUTPUT_FILE, target, trigger, identifier, fixed_trigger, percent, position,
                               multi_times,
                               poison_mode)